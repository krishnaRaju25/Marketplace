...
class Object_Mapper():
    ...
    def perform_compare(self,elementsdata):
        try:
            ...
            if 'view' not in elementsdata:   #CICD mode
                if elementsdata['scrapedurl']!=self.driver.current_url:
                    self.driver.get(elementsdata['scrapedurl'])
                elementsdata['view'] = elementsdata['testcase']
            ...
            for element in elementsdata['view']:
                if 'xpath' not in element and element['objectName']!='':
                    element['xpath'] = element['objectName']
                else:
                    continue
                ...
                decryptedelementurl = element['url'] or elementsdata['scrapedurl']
